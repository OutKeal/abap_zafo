...
CLASS:lcl_event_receiver_grid_200 DEFINITION DEFERRED.

DATA:g_event_receiver_grid_200 TYPE REF TO lcl_event_receiver_grid_200.
...
CLASS lcl_event_receiver_grid_200 IMPLEMENTATION.
  ...
  METHOD handle_onf4 .
    PERFORM f_handle_onf4_200 USING e_fieldname e_fieldvalue es_row_no er_event_data et_bad_cells.
  ENDMETHOD.

  METHOD handle_data_changed.
    PERFORM f_handle_data_changed_200 USING er_data_changed e_onf4.
  ENDMETHOD.
...
FORM f_handle_data_changed_200 USING  u_changed TYPE REF TO cl_alv_changed_data_protocol
                                      u_onf4    TYPE any.
...
FORM f_handle_onf4_200 USING e_fieldname TYPE  lvc_fname
...
FORM f_data_changed_finished_200  USING e_modified
  ...
  LOOP AT et_good_cells INTO DATA(ls_cell).
    ...
    CASE ls_cell-fieldname.
      WHEN 'EBELN'.
        PERFORM f_set_ebeln CHANGING <gs_item>.
      ...
      WHEN 'ZZPINO'.
        PERFORM f_set_zzpino CHANGING <gs_item>.
        IF gs_head-bustyp = 'DUC01'.
          PERFORM f_set_ebeln_duc01 CHANGING <gs_item>.
        ENDIF.
        ls_refresh = 'X'.
      ...
      WHEN 'ZPPDHD'.
        PERFORM f_zppdhd_f4 USING <gs_item>-zppdhd CHANGING <gs_item>-zppdhd.
        PERFORM f_set_zppdhd CHANGING <gs_item>.
        ls_refresh = 'X'.

      WHEN 'ZKUNNR_MAT'.
        PERFORM f_set_zkunnr_mat CHANGING <gs_item>.
        ls_refresh = 'X'.
      ...
      WHEN 'ZCOLOR_TEXT'.
        PERFORM f_set_zcolor_text CHANGING <gs_item>.
        ls_refresh = 'X'.
...
**--
    ...
    PERFORM f_set_drop_down_table USING g_grid_200 CHANGING gt_fcat_200   .
**-- DISPLAY GRID ALV
...
FORM f_assign_grid_handlers_200 CHANGING c_grid TYPE REF TO cl_gui_alv_grid.
  ...
  SET HANDLER g_event_receiver_grid_200->handle_onf4
         FOR c_grid .
...
FORM f_register_grid_event_200  USING u_grid TYPE REF TO cl_gui_alv_grid.
...
FORM f_display_grid_alv_200 .
  ...
  PERFORM frm_get_alv_handle
    USING sy-repid g_bustyp 'G_GRID_200' CHANGING ls_variant-handle.
