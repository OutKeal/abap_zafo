...
CLASS:
  lcl_event_receiver_grid_9001 DEFINITION DEFERRED.


DATA:
  g_event_receiver_grid_9001   TYPE REF TO lcl_event_receiver_grid_9001.

*&---------------------------------------------------------------------*
*&       CLASS LCL_EVENT_RECEIVER_GRID DEFINITION
*&---------------------------------------------------------------------*
CLASS lcl_event_receiver_grid_9001 DEFINITION.
...
*
*---------------------------------------------------------------------*
CLASS lcl_event_receiver_grid_9001 IMPLEMENTATION.
* DATA CHANGED
  METHOD handle_data_changed.
    PERFORM f_handle_data_changed_9001
  ...
  METHOD handle_double_click.
    PERFORM f_handle_double_click_9001 USING e_row e_column.
  ENDMETHOD.

  METHOD handle_hotspot_click.
    PERFORM f_handle_hotspot_click_9001 USING e_row_id e_column_id .
  ENDMETHOD.

  METHOD handle_toolbar.
    PERFORM f_toolbar_9001 USING e_object->mt_toolbar.
  ENDMETHOD.
  METHOD handle_user_command.
    PERFORM f_user_command_9001 USING e_ucomm.
  ENDMETHOD.


  METHOD data_changed_finished.
    PERFORM f_data_changed_finished_9001 USING e_modified et_good_cells.
  ENDMETHOD.


ENDCLASS.                    "LCL_EVENT_RECEIVER_GRID IMPLEMENTATION

DATA: g_grid_9001              TYPE REF TO cl_gui_alv_grid,
      gt_fcat_9001             TYPE lvc_t_fcat,
      gs_layout_9001           TYPE lvc_s_layo,
      gt_sort_9001             TYPE lvc_t_sort,
      gt_exclude_9001          TYPE ui_functions,
      g_docking_container_9001 TYPE REF TO cl_gui_docking_container,
      g_cumtom_container_9001  TYPE REF TO cl_gui_custom_container,
      g_container_9001         TYPE REF TO cl_gui_container,
      g_splitter_9001          TYPE REF TO cl_gui_splitter_container,
      g_toolbar_9001           TYPE REF TO cl_gui_toolbar.





FORM f_handle_data_changed_9001
...
FORM f_handle_double_click_9001 USING e_row_id TYPE lvc_s_row
...
FORM f_handle_hotspot_click_9001 USING e_row_id TYPE lvc_s_row
                                   e_column_id TYPE lvc_s_col.
...
FORM f_handle_user_command_9001 USING ok_code.
...
*      CLEAR:gt_item_dis.
*
*      CALL METHOD g_grid_9001->get_selected_rows
*        IMPORTING
...
FORM f_toolbar_9001 USING ut_toolbar TYPE ttb_button.
...
ENDFORM.
FORM f_user_command_9001 USING ok_code.
*  DATA:lt_index_rows TYPE  lvc_t_row,
*       ls_index_rows TYPE  lvc_s_row,
*       lt_row_no     TYPE  lvc_t_roid.
...
*
*
*      PERFORM  f_refresh_grid_alv USING g_grid_9001.
*    WHEN '&DEL'.
*
*      CALL METHOD g_grid_9001->get_selected_rows
*        IMPORTING
...
FORM f_data_changed_finished_9001  USING  e_modified
...
MODULE create_object_9001 OUTPUT.

  IF  g_grid_9001 IS INITIAL.
**-- CREATE CONTAINER
    PERFORM f_create_container_9001.
**-- FIELD_CATALOG DEFINE
    PERFORM f_set_grid_field_catalog_9001.
**-- LAYOUT
    PERFORM f_create_grid_layout_9001.
**-- TOOLBAR EXCLUDE
    PERFORM f_create_grid_toolbar_9001  CHANGING gt_exclude_9001[].
**-- GRID EVENT HANDLER DEFINE
    PERFORM f_assign_grid_handlers_9001 CHANGING g_grid_9001.
**-- REGISTER EVENT
    PERFORM f_register_grid_event_9001 USING g_grid_9001.
**--
    CALL METHOD cl_gui_cfw=>flush.
**-- DISPLAY GRID ALV
    PERFORM f_display_grid_alv_9001.
*--
    CALL METHOD g_grid_9001->set_ready_for_input
      EXPORTING
        i_ready_for_input = 1.
  ELSE.
...
FORM f_create_container_9001 .

  IF g_docking_container_9001 IS INITIAL.

    CREATE OBJECT g_docking_container_9001
      EXPORTING
        style     = cl_gui_control=>ws_child
        repid     = sy-repid
        dynnr     = sy-dynnr
        side      = g_docking_container_9001->dock_at_bottom
    ...
    ENDIF.
  ENDIF.
  CREATE OBJECT g_cumtom_container_9001
    EXPORTING
      container_name = 'ITEM'.


* SPLITTER CONTAINER
  IF g_splitter_9001 IS INITIAL.
    CREATE OBJECT g_splitter_9001
      EXPORTING
        parent  = g_docking_container_9001
        rows    = 1
        columns = 1.

    g_container_9001  = g_splitter_9001->get_container( row = 1 column = 1 ).
...
FORM f_set_grid_field_catalog_9001 .

  REFRESH: gt_fcat_9001.
  ...
  LOOP AT gt_fcat.
    CASE g_model.
      WHEN 'A'.
        IF gt_fcat-fieldname =   'ICON'
          OR gt_fcat-fieldname =  'MATNR'
          OR gt_fcat-fieldname = 'MAKTX'
          OR gt_fcat-fieldname = 'MENGE_CG'
          OR gt_fcat-fieldname = 'BPRME'
          OR gt_fcat-fieldname = 'IDNLF'
          OR gt_fcat-fieldname = 'ZCOLOR'
          OR gt_fcat-fieldname = 'ZCOLOR_TEXT_ZH'
  ...
  gt_fcat_9001 = gt_fcat[].

ENDFORM.


FORM f_create_grid_layout_9001 .

  CLEAR: gs_layout_9001.
  gs_layout_9001-sel_mode   = 'A'.
  gs_layout_9001-cwidth_opt = 'X'.
  gs_layout_9001-zebra      = 'X'.
...
FORM f_create_grid_toolbar_9001
...
FORM f_assign_grid_handlers_9001
  CHANGING c_grid TYPE REF TO cl_gui_alv_grid.

  CREATE OBJECT g_event_receiver_grid_9001.

  SET HANDLER g_event_receiver_grid_9001->handle_data_changed
          FOR c_grid .

  SET HANDLER g_event_receiver_grid_9001->handle_toolbar
          FOR c_grid .
  SET HANDLER g_event_receiver_grid_9001->data_changed_finished
        FOR c_grid.
  SET HANDLER g_event_receiver_grid_9001->handle_user_command
          FOR c_grid .
...
*          FOR C_GRID.
  SET HANDLER g_event_receiver_grid_9001->handle_hotspot_click
          FOR c_grid .
  SET HANDLER g_event_receiver_grid_9001->handle_double_click
          FOR c_grid .
...
FORM f_register_grid_event_9001
...
FORM f_display_grid_alv_9001 .
  ...
  CALL METHOD g_grid_9001->set_table_for_first_display
    EXPORTING
      ...
      it_toolbar_excluding = gt_exclude_9001[]
      i_default            = 'X'
    CHANGING
      it_outtab            = batch_item[]
      it_sort              = gt_sort_9001[]
...
FORM f_set_catalog_alv_9001.

  PERFORM f_set_grid_field_catalog_9001.

  CALL METHOD g_grid_9001->set_frontend_fieldcatalog
    EXPORTING
      it_fieldcatalog = gt_fcat_9001.

  CALL METHOD g_grid_9001->set_frontend_layout
    EXPORTING
      is_layout = gs_layout_9001.
